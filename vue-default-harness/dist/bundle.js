...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/vue/dist/vue.common.dev.js":[function(require,module,exports) {
...
exports.default = _default;
        var $309010 = exports.default || module.exports;
      
      if (typeof $309010 === 'function') {
        $309010 = $309010.options;
      }
    
        /* template */
        Object.assign($309010, (function () {
          var render = function() {
  var _vm = this
  ...
  methods: {
    ...
    add: function add(message) {
      ...
      if (!originalMessage.length) {
        ...
        message = _objectSpread({}, originalMessage[0], message);
      }
...
},{}],"components/toast/toast.css":[function(require,module,exports) {
...
function launchDialog() {
  ...
  data = makeDialogOptions.apply(void 0, arguments);
...
Vue.component("flux-dialog", {
  ...
  computed: {
    styles: function styles() {
      var res = {};
      res.display = this.display; // this.fullscreen === true or
  ...
  methods: {
    init: function init() {
      ...
      Object.entries(main.attributes).map(function (_ref) {
        ...
        if (item.nodeName in _this.$data) {
          _this[item.nodeName] = item.nodeValue;
    ...
    captureInitialFocus: function captureInitialFocus() {
      ...
      setTimeout(function () {
        var firstInput = _this2.$el.querySelector("input,select,textarea");
    ...
    registerEscapeListener: function registerEscapeListener() {
      ...
      var listener = function listener(event) {
        if (event.which === 27 && _this3.closable) {
...
function launchDialogPromise() {
  ...
  data.component.methods.$resolve = function () {
    if (false !== resolve.apply(void 0, arguments)) {
      this.$emit('close');
    }
  };

  data.component.methods.$reject = function () {
    if (false !== reject.apply(void 0, arguments)) {
      this.$emit('close');
    }
  };
...
_vue.default.directive('tab', function (el) {
...
_vue.default.prototype.link = function link(key) {
  var _this = this;
...
_vue.default.directive('autoheight', function (el) {
  el.wrap = 'off';
...
window.api = new Proxy({}, {
  get: function get(obj, method) {
    return function () {
      ...
      return _axios.default.post('?rpc=' + method, {
        rpc: [method, args]
      }).then(function (r) {
        return r.data;
      });
...
_vue.default.component('ui-suggest', _uiSuggest.default);
/* @endsnippet */
...
_vue.default.prototype.api = window.api;
...
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js","vue/dist/vue.common":"node_modules/vue/dist/vue.common.js","vue-blocks/vue-component-framework":"node_modules/vue-blocks/vue-component-framework.js","vue-router":"node_modules/vue-router/dist/vue-router.esm.js","./components/ui-suggest.vue":"components/ui-suggest.vue","./components/toast/index":"components/toast/index.js","./components/toast/toast.css":"components/toast/toast.css","./components/dialog/index":"components/dialog/index.js","./components/dialog/dialog.css":"components/toast/toast.css"}]},{},["bundle.js"], null)